...
define(['N/email', 'N/search', 'N/record', 'N/runtime', 'N/format'], function (email, search, record, runtime, format) {
    ...
    function generateEmailBody(approverId, invoices) {
		...
		// Start: Added the code below to check the Invoice type instead of the Item type (BSS-761)
		...
		// End: Added the code above to check the Invoice type instead of the Item type (BSS-761)
		
		
		
		
		// Start: Commented out the code below to check the Invoice type instead of the Item type (BSS-761)
		...
		// End: Commented out the code above to check the Invoice type instead of the Item type (BSS-761)
	...
	// Start: Added this function to show the amount to 2 decimal values BSS-761
